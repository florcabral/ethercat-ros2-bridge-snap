...
# Compatibility copy from ROS 2 Jazzy's ament_cmake_target_dependencies.
# ROS 2 Lyrical no longer provides this function, while the pinned ICube
# EtherCAT driver still uses it.
...
function(ament_target_dependencies target)
  ...
  if(${ARGC} GREATER 0)
    ...
    foreach(package_name ${ARG_UNPARSED_ARGUMENTS})
      ...
      # Prefer modern CMake interface targets when the package exports them.
